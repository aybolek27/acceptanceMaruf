...
Scenario: Invalid email 
	...
	Then the system shoul display error message "Invalid email address." 
...
Scenario: existing email 
	...
	Then the system shoul display error message "An account using this email address has already been registered. Please enter a valid password or request a new one." 
